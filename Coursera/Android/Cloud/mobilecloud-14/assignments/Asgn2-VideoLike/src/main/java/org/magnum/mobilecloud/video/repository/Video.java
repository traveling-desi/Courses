...
public class Video {
	...
	private long likes;
	@ElementCollection private Set<String> likedBy = new HashSet<String>();
	...
	@JsonIgnore
	public boolean setLikedBy(String user) {
		return likedBy.add(user);
	}

	
	@JsonIgnore
	public boolean removeLikedBy(String user) {
		return likedBy.remove(user);
	}
